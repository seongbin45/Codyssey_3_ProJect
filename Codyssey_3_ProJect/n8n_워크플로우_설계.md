...
결과 시트 ID: `1wz8bcpjNRIwq8o-skC49M2orEjfBNRpW2eETmjvwmrg`  
헤더 6열: `타임스탬프 | 원본 메모 | 카테고리 | 금액 | 요약 | 특이사항`

```
Google Sheets Trigger1 (Form Responses 1 / 1aZZ…)
...
Make Trigger: 시트 `Form Responses 1`, 스프레드시트 `1aZZXJaWqMkydaAICT42N2GKtZiAMbPk6PYCHg3PtUQ4`  
...
결과 스프레드시트: `1wz8bcpjNRIwq8o-skC49M2orEjfBNRpW2eETmjvwmrg`
...
| 용도 | 문서 이름(추정) | ID |
|---|---|---|
| **Trigger** — 폼 응답 시트 | 지출 메모 입력 폼 (응답) | `1aZZXJaWqMkydaAICT42N2GKtZiAMbPk6PYCHg3PtUQ4` |
| **Action** — 분류 결과 시트 | 지출 자동 분류 결과 | `1wz8bcpjNRIwq8o-skC49M2orEjfBNRpW2eETmjvwmrg` |
| 폼 (수동 테스트 제출용) | 지출 메모 입력 폼 | viewform: `.../e/1FAIpQLScT2udcpN0LG1ASVMouoisJWppHuxNTew-kHEuiL_6lboD40w/viewform` |
