...
| 보고서용 복사 | `report/gifs/` (본문 상대경로) | ✅ Make 6개 복사 + 영문 별칭 |
| n8n | `report/gifs/n8n_*.gif` | ⬜ **앞으로 촬영** |
...
| `n8n_setup_or_oauth.gif` | (선택) 로컬 기동 또는 credential 연결 | 선택 |
...
![n8n 설치·OAuth 마찰 스토리보드](gifs/n8n_setup_or_oauth.gif)

> 애니메이션: 6장면 순환 · 정지본 `n8n_setup_or_oauth.png`

| # | 파일 | 내용 (로그 출처) |
|---|------|------------------|
| 1 | `gifs/n8n_friction_01_windows_sdk_missing.png` | `isolated-vm` / `missing any Windows SDK` |
| 2 | `gifs/n8n_friction_02_sdk_and_nodegyp_fix.png` | winget SDK 설치 성공 → node-gyp 11 재빌드 |
| 3 | `gifs/n8n_friction_03_n8n_ready.png` | `n8n ready` / `Editor is now accessible` |
| 4 | `gifs/n8n_friction_04_oauth_client_not_found.png` | `The OAuth client was not found` |
| 5 | `gifs/n8n_friction_05_oauth_test_users.png` | 테스트 모드 403 `access_denied` |
| 6 | `gifs/n8n_friction_06_credentials_connected.png` | Trigger + Sheets OAuth 이중 연결 완료 |

![마찰 1 · Windows SDK](gifs/n8n_friction_01_windows_sdk_missing.png)

![마찰 4 · OAuth client not found](gifs/n8n_friction_04_oauth_client_not_found.png)

![마찰 5 · 테스트 사용자](gifs/n8n_friction_05_oauth_test_users.png)
