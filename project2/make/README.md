...
| 입력 (문의 내용) | 기대 |
|------------------|------|
| (설계 예시) 결제가 안 돼요, 지금 당장 필요해요 | 「긴급 문의」탭 + **Slack `#새-채널`** |
| (설계 예시) 다크모드 지원 언제 되나요? | 「일반 문의」탭만 |
| (GIF 실증거) 탕비실·커피 등 긴급 문구 | `../gif/make_urgent_*.gif` · Slack 포함 |
| (GIF 실증거) 피곤/퇴근 등 일반 문구 | `../gif/make_normal_*.gif` · Slack 없음 |

> 알림 채널은 **Gmail/이메일이 아니라 Slack Public `#새-채널`** 이다. (구 Blueprint `email:ActionSendEmail` 경로는 폐기)
