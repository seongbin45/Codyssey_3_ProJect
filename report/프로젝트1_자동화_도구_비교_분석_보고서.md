...
**작성 상태:** Make·n8n 실행 GIF 반영 완료 (미디어 경로 `gif/`)  
...
원본 한글 파일명의 「일반/기타」 라벨이 실제 입력과 어긋나, **프레임 검수 후** 아래 영문 별칭으로 `gif/` 에 복사했다. 상세는 `n8n_gif/README.md`.
...
| GIF 폴더 | `gif/` (Make·n8n 실행 영문 별칭) / `n8n_gif/` (n8n 원본) / `png/` (마찰) |
...
*Make·n8n 실행 미디어 반영 완료. 보고서 링크는 `gif/` 영문 별칭을 사용한다.*
