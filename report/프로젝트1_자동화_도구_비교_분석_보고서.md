...
**작성 상태:** **제출본** (Make·n8n 구현·GIF·비교 항목·마스킹 완료, 미디어 경로 `make_gif/`)  
...
| 구분 | 경로 | 상태 |
|------|------|------|
| 보고서용 실행 GIF | `make_gif/` (`make_*.gif`, `n8n_*.gif`) | ✅ 12개 |
| n8n 녹화 원본 | `n8n_gif/` (한글 파일명) | ✅ 원본 6개 + 매핑 README |
...
원본 한글 파일명의 「일반/기타」 라벨이 실제 입력과 어긋나, **프레임 검수 후** 아래 영문 별칭으로 `make_gif/` 에 복사했다. 상세는 `n8n_gif/README.md`.
...
#### Make 동작 GIF (촬영 완료 · `make_gif/`)

**고액 분기 — 폼 응답**

![Make 고액 · 폼 양식 응답](../make_gif/make_high_1_form.gif)

**고액 분기 — 시나리오 액션**

![Make 고액 · 에이전트 액션](../make_gif/make_high_2_action.gif)

**일반 분기 — 폼 응답**

![Make 일반 · 폼 양식 응답](../make_gif/make_normal_1_form.gif)

**일반 분기 — 시나리오 액션**

![Make 일반 · 에이전트 액션](../make_gif/make_normal_2_action.gif)

**미분류(기타) 분기 — 폼 응답**

![Make 미분류 · 폼 양식 응답](../make_gif/make_review_1_form.gif)

**미분류(기타) 분기 — 시나리오 액션**

![Make 미분류 · 에이전트 액션](../make_gif/make_review_2_action.gif)

> 경로: `make_gif/make_*.gif`. 워크플로우 정지 캡처: `make/Make_workflow_view.jpeg`.
...
#### n8n 동작 GIF (촬영·매핑 완료 · `make_gif/`)

Make와 동일하게 **폼 응답 + 에이전트 액션** 2장씩. 원본은 `n8n_gif/`, 보고서 링크는 내용 기준 영문 별칭.
...
![n8n 고액 · 폼 양식 응답](../make_gif/n8n_high_1_form.gif)

**고액 분기 — 에이전트 액션** (고액 탭 행 확인)

![n8n 고액 · 에이전트 액션](../make_gif/n8n_high_2_action.gif)

**일반 분기 — 폼 응답** (`마트에서 식용유 5800원`)

![n8n 일반 · 폼 양식 응답](../make_gif/n8n_normal_1_form.gif)

**일반 분기 — 에이전트 액션** (일반 탭 · 생필품 5800)

![n8n 일반 · 에이전트 액션](../make_gif/n8n_normal_2_action.gif)

**미분류 분기 — 폼 응답** (`분류 잘 모르겠음 -5000`)

![n8n 미분류 · 폼 양식 응답](../make_gif/n8n_review_1_form.gif)

**미분류 분기 — 에이전트 액션** (검토 필요 탭)

![n8n 미분류 · 에이전트 액션](../make_gif/n8n_review_2_action.gif)
...
| GIF 폴더 | `make_gif/` (Make·n8n 실행 영문 별칭) / `n8n_gif/` (n8n 원본) / `png/` (마찰) |
...
- [x] `make_gif/` 에 Make 6 + n8n 6 실동작 GIF 채우기  
...
| # | 파일 | 상태 |
|---|------|------|
| M1–M6 | Make 고액/일반/기타 × (폼+액션) | ✅ `make_gif/make_*.gif` |
| N1–N6 | n8n 고액/일반/검토 × (폼+액션) | ✅ `make_gif/n8n_*.gif` (내용 기준 매핑) |
| W1 | n8n 캔버스 정지 캡처 | ✅ `n8n/n8n_workflow_view.png` (마스킹 검수 통과) |
| W2 | Make 캔버스 정지 캡처 | ✅ `make/Make_workflow_view.jpeg` (마스킹 검수 통과) |
| F1 | `png/n8n_setup_or_oauth.gif` 및 friction 01–06 | ✅ |

---

*프로젝트 1 제출본. 실행 GIF는 `make_gif/` 영문 별칭. 프로젝트 2는 별도 `project2/` 에서 진행.*
